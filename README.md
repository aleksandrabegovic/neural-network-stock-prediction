...
Nakon sentiment analize, vesti su povezane sa istorijskim podacima o cenama akcija korišćenjem vremenskog usklađivanja sa narednim trgovačkim danom. Kreirani su dodatni atributi poput prinosa, pokretnih proseka sentimenta i zaostalih vrednosti sentimenta.
...
Model za predikciju kretanja akcija jedan dan unapred ostvario je tačnost od 82,62%.

Model za predikciju kretanja akcija dva dana unapred ostvario je tačnost od 65,24%.
...
Rezultati istraživanja pokazuju da kombinacija sentiment karakteristika finansijskih vesti i istorijskih prinosa akcija može biti korisna za predikciju kratkoročnog kretanja cena akcija. Najbolje performanse ostvarene su kod modela za predikciju jedan dan unapred, sa tačnošću od 82,62%, dok se tačnost smanjuje na 65,24% za dva dana i 55,63% za tri dana unapred.
...
Rezultati su pokazali da model ostvaruje najbolje performanse pri predikciji jedan dan unapred, dok se tačnost smanjuje sa povećanjem vremenskog horizonta predikcije. Takođe, poređenje sa modelom koji koristi samo sentiment karakteristike pokazalo je da istorijski prinosi i tržišni pokazatelji imaju značajnu ulogu u unapređenju performansi modela.

Na osnovu dobijenih rezultata može se zaključiti da kombinovanje informacija iz finansijskih vesti i istorijskih tržišnih podataka predstavlja koristan pristup za predikciju kratkoročnog kretanja akcija. Buduća istraživanja mogu uključiti dodatne finansijske indikatore i naprednije arhitekture neuronskih mreža radi daljeg poboljšanja rezultata.
